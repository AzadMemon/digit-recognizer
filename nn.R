...
fn <- costFunction(trainDataX, trainDataY, lambda)
gr <- gradFunction(trainDataX, trainDataY, lambda)

result <- optim(par = init_theta, fn, gr, method="L-BFGS-B", control=list(maxit=500, trace=1))
